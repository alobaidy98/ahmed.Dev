...
git clone https://github.com/alobaidy98/ahmed.Dev.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf ahmed.Dev && rm -rf .telegram-cli && git clone git clone https://github.com/alobaidy98/ahmed.Dev.git && cd ahmed.Dev && ./launch.sh install && ./launch.sh
~~~~~
